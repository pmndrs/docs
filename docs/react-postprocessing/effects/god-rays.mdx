...
The GodRays effect requires a mesh that will be used as an origin point for the rays. Refer to this [example](https://github.com/react-spring/@react-three/postprocessing/tree/master/examples/take-control) for more details.
