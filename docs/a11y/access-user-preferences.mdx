...
These are CSS medias features and this library expose two of them
...
Some user on your website might need all animation turned off or limited to what's strictly nescessary.
