---
title: Introduction
description: How to use @react-three/a11y
nav: 0
---
...
### First the A11yAnnouncer component

First, place the A11yAnnouncer component next to the R3F Canvas component. This is critical, because it will manage the screen-reader.
...
`MyComponent` can now receive focus. More accurately, the emulated "focus" will handled at the `A11y` components which acts as a provider
