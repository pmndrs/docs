...
For a user using a screen reader, as is, he could not read it.
...
<Hint>
  For people using screen readers it will also sync some kinf of focus indicator natively where your
...
For this example, screenreader don't trigger focus when swipping their screen so it would benefit people used to navigate through keyboard without hurting screenreader users.
