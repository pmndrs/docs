...
This library is pretty simple, if you're curious about how it works you can read the following information and even look at the internals.
...
role="link" => a <br />
role="button" => button <br />
role="content" => p <br />
role="togglebutton" => button <br />
...
It uses a zustand store to update the div with each new message.
