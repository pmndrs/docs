...
Embed external content like Storybook stories, YouTube videos, or any iframe-compatible content.
...
By default, the iframe uses a 16:9 aspect ratio. You can customize it:
...
> [!TIP]
> The `Iframe` component supports all standard HTML iframe attributes like `allow`, `sandbox`, `referrerPolicy`, etc.
