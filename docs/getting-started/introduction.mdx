...
NB: see https://www.youtube.com/playlist?list=PLsoLz-E4Os4WWkrvRuQ7BJuVF-WfOyfWT for more information
NB: we currently don't have secondary/tertiary colors (maybe some day).
