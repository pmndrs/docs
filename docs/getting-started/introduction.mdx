...
## Local Development for the Docs repo

If you've cloned this repo and want to work on it locally:
...
Start a development server from any project's `docs` folder:

```sh
# From your project directory
$ npx @pmndrs/docs dev ./docs --libname="Koota"
```
...
```sh
$ npx @pmndrs/docs dev ./docs --libname="My Library" --port=3001
```

For all available options:

```sh
$ npx @pmndrs/docs dev --help
```

> [!TIP]
> You can also install `@pmndrs/docs` locally as a devDependency and add a script to your `package.json`:
> ```json
> {
>   "scripts": {
>     "docs:dev": "dev ./docs --libname=\"My Library\""
>   }
> }
> ```

<details>
  <summary>Advanced: Manual setup with environment variables</summary>

If you've cloned this repo and want to use environment variables directly:
