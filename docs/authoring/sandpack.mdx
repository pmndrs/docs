...
> [!IMPORTANT]
> Sandpack is an **external component**. To use it, you need to:
> 1. Install the package: `npm install @codesandbox/sandpack-react`
> 2. It's enabled by default, or explicitly enable via: `export EXTERNAL_SANDPACK=true`
> 
> See [External Components](./external-components.mdx) for more details.
