...
<Intro>
  The Sandpack component provides inline, interactive code sandboxes powered by CodeSandbox. It supports multiple templates and custom dependencies. Advanced features include file organization, file explorers, code viewers, and SSR rendering. This makes it perfect for live code examples in documentation.
</Intro>
...
**Sandpack with folder prop**:

Instead of `files`, a `folder` prop allows you to pass a folder containing all the files:
