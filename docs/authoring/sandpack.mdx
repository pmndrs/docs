...
<Intro>
  The Sandpack component provides inline, interactive code sandboxes powered by CodeSandbox. It supports multiple templates, custom dependencies, file organization, and advanced features like file explorers, code viewers, and SSR rendering, making it perfect for live code examples in documentation.
</Intro>
