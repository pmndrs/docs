...
> [!TIP]
>
> When using special characters like backticks (`) in frontmatter values, wrap the entire value in quotes: `title: '`Intro`'` or `title: "`Intro`"`. For plain text without special characters, quotes are optional: `title: My Title`.
