...
Most Threejs apps run in a game-loop, they render 60 times per second. Three-fiber is no different. This is perfect when your scene has moving parts in it. This is what generally drains batteries and makes fans spin up. 

Given that movement in your scene is only temporary and may come to a still stand, then you can opt into on-demand rendering, which will only render when necessary. This saves battery and keeps fans from going crazy.
