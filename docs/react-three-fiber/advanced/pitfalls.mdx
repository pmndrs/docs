...
description: Some very important things to know for smooth results
nav: 20
---

## WebGL performance pitfalls
...
#### ✅ Instead, use refs and mutate! This is totally fine and that's how you would do it in plain three.js as well
