...
This is totally fine and that's how you would do it in plain three.js as well
...
See: [transiten updates for often occuring state changes](https://github.com/react-spring/zustand#transient-updates-for-often-occuring-state-changes).
