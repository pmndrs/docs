...
This tutorial will assume some React and TypeScript knowledge and will base off of [this starter codesandbox](https://codesandbox.io/s/brnsm), so you can fork it and follow along.
...
react-three-fiber exports helpers that you can use to define different types of nodes. These nodes will define an element that we'll attach to the global JSX namespace.
