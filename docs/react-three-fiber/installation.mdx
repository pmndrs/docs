...
<Callout>If you just want to give it a try, fork this [simple example on codesandbox]()!</Callout>
...
<Callout>
  Check out the [official next.js
  example](https://github.com/vercel/next.js/tree/canary/examples/with-three-js) for
  react-three-fiber.
</Callout>
