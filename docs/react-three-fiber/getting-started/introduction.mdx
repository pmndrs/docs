...
- Make sure you have a [basic grasp of `three.js`](https://three.js.org/docs/index.html#manual/en/introduction/Creating-a-scene). Keep that site open.
...
- [Look up](https://three.js.org/docs/index.html#api/en/objects/Mesh) the JSX elements that you see (mesh, ...), _all_ three.js exports are native to React Three Fiber.
- Try changing some values, scroll through our [API](/markdown/api.md) to see what the various settings and hooks do.

### Some reading material:

- [three.js-docs](https://three.js.org/docs)
- [three.js-examples](https://three.js.org/examples)
- [three.js-fundamentals](https://three.jsfundamentals.org)
- [Discover three.js](https://discoverthree.js.com)
- [Do's and don'ts](https://discoverthree.js.com/tips-and-tricks) for performance and best practices
- [react-three-fiber alligator.io tutorial](https://alligator.io/react/react-with-three.js) by [@dghez\_](https://twitter.com/dghez_)
