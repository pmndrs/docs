...
You can use Fiber on `Next.js` by installing the `next-transpile-modules` module:
...
You can try React Three Fiber with browser-ready ES Modules from [skypack.dev](https://skypack.dev) and a JSX-like syntax powered by [htm](https://github.com/developit/htm).

See an [example on codepen](https://codepen.io/mattrossman/pen/mdRGJBy).
