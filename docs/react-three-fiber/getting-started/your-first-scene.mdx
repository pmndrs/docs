...
````js const color = new THREE.Color('black') // args is the arguments array, passed to the
constructor scene.background = color // set the property on a three.js object parent[attach] =
object ```
