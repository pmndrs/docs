...
myMesh.material = new THREE.MeshPhongMaterial()
...
To better understand this, we can take a look at the [documentation for THREE's `BoxGeometry`](https://threejs.org/docs/#api/en/geometries/BoxGeometry), that tells us how the geometry is constructed:
