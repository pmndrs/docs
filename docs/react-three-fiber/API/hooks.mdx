...
| set             | Allows you to set any state property                      | `() => GetState<RootState>`                                                                                                                                                                                    |
| get             | Allows you to retrieve any state property non-rteactively | `(state: SetState<RootState>) => void`                                                                                                                                                                         |
