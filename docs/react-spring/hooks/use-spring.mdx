...
<DemoGrid>
  ...
  ></Demo>
  <Demo title="Card" url="github/pmndrs/react-spring/tree/master/demo/src/sandboxes/card"></Demo>
  <Demo
    title="CSS Keyframes"
  ...
  ></Demo>
  <Demo title="Slide" url="github/pmndrs/react-spring/tree/master/demo/src/sandboxes/slide"></Demo>
  <Demo
    url="github/pmndrs/react-spring/tree/master/demo/src/sandboxes/svg-filter"
    title="SVG Filter"
  ></Demo>
  <Demo title="Tree" url="github/pmndrs/react-spring/tree/master/demo/src/sandboxes/tree"></Demo>
</DemoGrid>
